 ...
 * uma das tarefas a serem trabalhadas durante a sprint, como desenvolvedor da empresa você 
 * recebeu os requisitos para a nova implementação que consiste em uma solução algorítmica que 
 * permita aos clientes realizarem saques em caixas eletrônicos. No entanto, existem algumas regras a 
 * serem seguidas para garantir que um saque possa ser realizado com sucesso.
 * 
 * Regras do saque:
